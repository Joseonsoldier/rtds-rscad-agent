...
from . import __version__, knowledge, execution, project_tools, editing
...
def anticipated_errors(function):
    ...
    call.__annotations__ = get_type_hints(function)
    return call
...
READ = [knowledge.get_knowledge_status, knowledge.search_rtds_local, knowledge.get_manual_page,
        ...
        project_tools.compare_projects, project_tools.trace_signal, execution.get_execution_policy,
        execution.get_workflow_status, execution.revalidate_execution_evidence]
LOCAL_WRITE = [knowledge.get_manual_figure, editing.apply_parameter_patch,
